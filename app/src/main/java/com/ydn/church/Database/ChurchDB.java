...
public class ChurchDB {
    ...
    public void createTable(){
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS MY_ALARM(SEQUENCE VARCHAR2(5), SUB_TITLE VARCHAR2(20),  PAGE VARCHAR2(20), ALARM_TIME VARCHAR2(20) NOT NULL, ALARM_YN VARCHAR2(2));");
